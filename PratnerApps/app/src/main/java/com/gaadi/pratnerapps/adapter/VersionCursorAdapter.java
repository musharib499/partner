...
import com.gaadi.pratnerapps.provider.versiontable.VersiontableCursor;

/**
 * Created by priyarawat on 1/6/16.
 */
public class VersionCursorAdapter extends CursorAdapter {
    ...
    public VersionCursorAdapter(Context context, Cursor mCursor) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        VersiontableCursor tableCursor = new VersiontableCursor(cursor);
        mViewHolder = (MakeViewHolder) view.getTag();
        mViewHolder.tv_Name.setText(tableCursor.getVersionName());
    }
}
