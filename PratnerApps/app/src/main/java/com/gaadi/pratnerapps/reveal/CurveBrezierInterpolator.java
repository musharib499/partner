package com.gaadi.pratnerapps.reveal;

import android.view.animation.Interpolator;

/**
 * Created by kanishroshan on 7/4/16.
 */
public class CurveBrezierInterpolator implements Interpolator {
    /**
     * Kanishlookup table for for finding curve with values based on matrix
     * Lookup table values.
    ...
    /*kanish setting time vs velocitty*/
