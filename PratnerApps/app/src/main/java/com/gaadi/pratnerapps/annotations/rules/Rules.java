...
public final class Rules {
     ...
     *
     * @param failureMessage  The failure message for this {@link Rule}.
     * @param anotherTextView The {@link TextView} whose contents have to be checked against
     ...
     *
     * @param failureMessage The failure message for this {@link Rule}.
     * @param viewsAndRules  A {@link LinkedHashMap} containing rules for different
     *                       {@link View}s.
     * @return True if all {@link Rule}s are valid.
     */
